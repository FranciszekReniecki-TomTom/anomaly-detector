...
open class AnomalyService {
    ...
    //        val trafficData: List<TrafficTileHour> = getData(startDay, endDay,
    ...
    //                // This is a quick way if tileId is not directly accessible here (not ideal
    // for //
    //                // perf)
    //                val tileId =
    ...
    //            }
    //
    //        val minTimeInSeconds =
    // anomalyRequestDto.startDay.toEpochSecond(ZoneOffset.UTC).toDouble()
    //        val maxTimeInSeconds =
    // anomalyRequestDto.endDay.toEpochSecond(ZoneOffset.UTC).toDouble()
    ...
    //                    (dataPoint.hour.toEpochSecond(ZoneOffset.UTC).toDouble() -
    // minTimeInSeconds) /
    //                        timeRange,
    //                )
    //            }
    ...
    //        val structs: List<List<PointRef>> = clustered.map { it.map { index ->
    // flatPoints[index] } }
    //
    //        // [Int -> [PointRef]]
